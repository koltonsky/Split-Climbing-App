...
import kotlinx.android.synthetic.main.climb_three_screen.*

class ClimbThreeScreen: AppCompatActivity(){

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.climb_three_screen)

        backThree.setOnClickListener {
            startActivity(Intent(this, ClimbList::class.java))
        }

        val chk1 = findViewById<CheckBox>(R.id.checkBoxThree)
        val database = getSharedPreferences("database", Context.MODE_PRIVATE)
        val checkMark = getSharedPreferences("checking", Context.MODE_PRIVATE)
        val isChecked = checkMark.getBoolean("climbCheckThree", false)
        ...
        chk1.setOnClickListener { v ->
            ...
            if (box1) {
                ...
                checkMark.edit().apply {
                    putBoolean("climbCheckThree", true)
                }.apply()
                ...
                checkMark.edit().apply {
                    putBoolean("climbCheckThree", false)
                }.apply()
